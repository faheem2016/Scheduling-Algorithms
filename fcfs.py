...
def calculate_waiting_and_turnaround_tTime(start_time, process_queue, waiting_time_queue,finish_time,turn_around_time):
...
calculate_waiting_and_turnaround_tTime(start_time, process_queue, waiting_time_queue,finish_time,turn_around_time)
